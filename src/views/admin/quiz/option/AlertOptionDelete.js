...
export default function AlertOptionDelete({ title, open, handleClose }) {
    return (
        <Dialog
            open={open}
        ...
        >
            {open && (
                <>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            By deleting user option, all task inside that user option will also be deleted.
                        </DialogContentText>
                    </DialogContent>
