...
export default function AlertQuestionDelete({ title, open, handleClose }) {
    return (
        <Dialog
            open={open}
        ...
        >
            {open && (
                <>
                    ...
                    <DialogContent>
                        <DialogContentText>
                            By deleting user question, all task inside that user question will also be deleted.
                        </DialogContentText>
                    </DialogContent>
